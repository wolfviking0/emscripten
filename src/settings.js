...
// Print out debugging information from our OpenCL implementation.
var CL_DEBUG = 0; 

// Use validator on the kernel --preload-file-validator
var CL_VALIDATOR = 0; 

// Add parameter to the validator
var CL_VAL_PARAM = [];

// Grab all the wecl call 
var CL_GRAB_TRACE = 0 

// Print all the wecl call auto after each webcl call
var CL_PRINT_TRACE = 0 
...
// Grab all the cuda call
var CU_GRAB_TRACE = 0 

// Print all the cuda call auto after each cuda call
var CU_PRINT_TRACE = 0 

// Check if object is inside the hashmap
var CU_CHECK_VALID_OBJECT = 0 
